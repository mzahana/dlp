...
class MasterC():
	def __init__(self):
		...
		for i in range(self.Nd):
			self.d_gps_topic_names.append('/defender'+str(i+1)+'/mavros/global_position/global')

		self.e_gps_topic_names = []
		for i in range(self.Ne):
			self.e_gps_topic_names.append('/attacker'+str(i+1)+'/mavros/global_position/global')
