...
def main():
	...
	rospy.Subscriber(mObj.d_gps_topic_names[3], NavSatFix, mObj.d4poseCb)
	rospy.Subscriber(mObj.d_gps_topic_names[4], NavSatFix, mObj.d5poseCb)
	rospy.Subscriber(mObj.d_gps_topic_names[5], NavSatFix, mObj.d6poseCb)
	rospy.Subscriber(mObj.d_gps_topic_names[6], NavSatFix, mObj.d7poseCb)
	rospy.Subscriber(mObj.d_gps_topic_names[7], NavSatFix, mObj.d8poseCb)
	rospy.Subscriber(mObj.d_gps_topic_names[8], NavSatFix, mObj.d9poseCb)
	...
	rospy.Subscriber(mObj.e_gps_topic_names[3], NavSatFix, mObj.e4poseCb)
